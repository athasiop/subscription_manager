...
class CurrPlansAndReviews(tk.Tk):
    def __init__(self):
        tk.Tk.__init__(self)
        ...
        self.frames={} 
        self.frames[CurrentPlans] = CurrentPlans(container, cur, currUserID ,self.frames)    
        self.frames[CurrentPlans].pack()
        
        self.show_frame(CurrentPlans)
    def show_frame(self,cont):
        frame = self.frames[cont] 
        frame.tkraise()
        
class CurrentPlans(tk.Frame):
        def __init__(self, parent, cur, currUserID, frames):
            ...
            self.lblActUser = tk.Label(self, text = "")
            ...
            self.lblActUser.config(text = currUser)
            
            self.lblActUser.pack()
            self.lblActPlans.pack()
            
            self.treePlans.pack()
            self.btnCancelPlan.pack()
            
            self.btnReviewPlan.pack()
            self.lblReviews.pack()
            self.treeReviews.pack()
